...
<div class="tambah-gejala">
    <form action="/Admin_dataGejala/simpanDataGejala/" method="POST">
        <?= csrf_field(); ?>
        <div class="title">
            <label for="exampleInputEmail1" class="form-label">
                <h3>Buat Data Gejala Baru</h3>
            </label>
        </div>
        <div class="headline">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Kode Gejala</label>
                <input name="kode_gejala" type="text" autofocus value="<?= old('kode-gejala'); ?>" class="form-control <?= ($validation->hasError('kode_gejala')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="The correct data-gejala's code is start using G letter. Example : G01 and next..">
        ...
        <div class="konten">
            <div class="mb-3">
                ...
                <textarea name="gejala" type="text" value="<?= old('gejala'); ?>" class="form-control <?= ($validation->hasError('gejala')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write the symtomps" cols="30" rows="10"></textarea>
                <div id="validationServer05Feedback" class="invalid-feedback">
