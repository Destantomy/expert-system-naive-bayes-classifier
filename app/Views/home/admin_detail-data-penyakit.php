...
<div class="detail-penyakit">
    <form action="/Admin_dataPenyakit/updateDataPenyakit/<?= $data_penyakit['id']; ?>" method="POST">
        <?= csrf_field(); ?>
        ...
        <div class="headline">
            <div class="mb-3">
                ...
                <input name="kode_penyakit" type="text" autofocus value="<?= $data_penyakit['kode_penyakit']; ?>" class="form-control <?= ($validation->hasError('kode_penyakit')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write the disease's code">
        ...
        <div class="konten">
            <div class="mb-3">
                ...
                <input name="penyakit" type="text" value="<?= $data_penyakit['penyakit']; ?>" class="form-control <?= ($validation->hasError('penyakit')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write the disease's name" cols="30" rows="10">
                <div id="validationServer05Feedback" class="invalid-feedback">
        ...
        <div class="konten">
            <div class="mb-3">
                ...
                <textarea name="penanganan" style="height: 7rem;" class="form-control <?= ($validation->hasError('penanganan')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write the disease's handling" cols="30" rows="10"><?= $data_penyakit['penanganan']; ?></textarea>
                <div id="validationServer05Feedback" class="invalid-feedback">
        ...
        <div class="konten">
            <div class="mb-3">
                ...
                <input name="probabilitas" type="number" step="any" min="0" max="1" value="<?= $data_penyakit['probabilitas']; ?>" class="form-control <?= ($validation->hasError('probabilitas')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write the disease's probability value between 0 - 1" cols="30" rows="10">
                <div id="validationServer05Feedback" class="invalid-feedback">
                    <?= $validation->getError('probabilitas'); ?>
                </div>
            </div>
        </div>
        <button type="submit" class="btn btn-warning" onclick="return confirm('Update data penyakit?');">Update</button>
        <a href="/penyakit/<?= $data_penyakit['id']; ?>" class="btn btn-danger" onclick="return confirm('Hapus data penyakit?');">Delete</a>
        <a href="/Admin_dataPenyakit/dataPenyakit/" class="btn btn-back"><i class="fa-solid fa-arrow-rotate-left"></i> Back</a>
    </form>
</div>
<!-- end-konten -->
<script>
    ...
    const konten = document.querySelector(".detail-penyakit");
    button1.onclick = () => {
