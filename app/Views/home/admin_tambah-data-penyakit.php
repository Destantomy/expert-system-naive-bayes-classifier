...
<!--endsidebar-->
<!-- konten -->
<div class="tambah-penyakit">
    <form action="/Admin_dataPenyakit/simpanDataPenyakit/" method="POST">
        <?= csrf_field(); ?>
        <div class="title">
            <label for="exampleInputEmail1" class="form-label">
                <h3>Buat Data Penyakit Baru</h3>
            </label>
        </div>
        <div class="headline">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Kode Penyakit</label>
                <input name="kode_penyakit" type="text" autofocus value="<?= old('kode-penyakit'); ?>" class="form-control <?= ($validation->hasError('kode_penyakit')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="The correct data-penyakit's code is start using P letter. Example : P01 and next..">
        ...
        <div class="konten">
            <div class="mb-3">
                ...
                <input name="penyakit" type="text" value="<?= old('penyakit'); ?>" class="form-control <?= ($validation->hasError('penyakit')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write the disease's name" cols="30" rows="10">
                <div id="validationServer05Feedback" class="invalid-feedback">
        ...
        <div class="konten">
            <div class="mb-3">
                ...
                <textarea name="penanganan" style="height: 7rem;" class="form-control <?= ($validation->hasError('penanganan')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write the disease's handling" cols="30" rows="10"></textarea>
                <div id="validationServer05Feedback" class="invalid-feedback">
        ...
        <div class="konten">
            <div class="mb-3">
                ...
                <input name="probabilitas" type="number" step="any" min="0" max="1" value="<?= old('probabilitas'); ?>" class="form-control <?= ($validation->hasError('probabilitas')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Insert the disease's probability value between 0 - 1" cols="30" rows="10">
                <div id="validationServer05Feedback" class="invalid-feedback">
...
<script>
    ...
    const konten = document.querySelector(".tambah-penyakit");
    button1.onclick = () => {
