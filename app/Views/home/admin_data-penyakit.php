...
<div class="data-penyakit">
    <div class="tambah-data-penyakit" style="float: left;">
        <a href="/Admin_dataPenyakit/tambahDataPenyakit" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Tambah Data Penyakit</a>
    </div>
    <div class="form-cari">
    ...
    <div class="tabel-penyakit">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <?php foreach ($data_penyakit as $dpy) : ?>
                    <tr>
                        <th scope="row"><?= $no++; ?></th>
                        <td><?= $dpy['kode_penyakit']; ?></td>
                        <td><?= $dpy['penyakit']; ?></td>
                        <td>Selengkapnya..</td>
                        <td><?= $dpy['probabilitas']; ?></td>
                        <td>
                            <a href="/Admin_dataPenyakit/detailDataPenyakit/<?= $dpy['id']; ?>" class="btn btn-success">Detail</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        <?= $pager->links('data_penyakit', 'data_pengguna_pager'); ?>
    </div>
</div>
<!-- end-content -->
<script>
