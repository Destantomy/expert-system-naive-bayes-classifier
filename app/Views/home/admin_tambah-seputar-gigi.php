...
<div class="tambah-artikel">
    <form action="/Admin_seputarGigi/tambahArtikel/" method="POST">
        <?= csrf_field(); ?>
        <div class="title">
        ...
        <div class="headline">
            <div class="mb-3">
                ...
                <input name="headline" type="text" autofocus value="<?= old('headline'); ?>" class="form-control <?= ($validation->hasError('headline')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write here the article's title">
        ...
        <div class="konten">
            <div class="mb-3">
                ...
                <textarea name="konten" type="text" value="<?= old('konten'); ?>" class="form-control <?= ($validation->hasError('konten')) ? 'is-invalid' : ''; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Write here the article's content" cols="30" rows="10"></textarea>
                <div id="validationServer05Feedback" class="invalid-feedback">
